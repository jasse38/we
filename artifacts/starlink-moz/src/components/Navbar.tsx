...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-[#0a1628] border-b border-blue-900/50 shadow-lg">
      ...
      {open && (
        <div className="md:hidden bg-[#0d1e38] border-t border-blue-900/50 px-4 pt-2 pb-4 space-y-1">
          {links.map((l) => (
            <Link
              key={l.href}
              href={l.href}
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="mt-2 block bg-green-500 text-white text-sm font-semibold px-4 py-2 rounded-lg text-center"
          >
            Falar no WhatsApp
          </a>
        </div>
