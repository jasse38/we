import { Wifi, Camera, Bell, Flame, Zap, DoorOpen, BarChart2, Lock, Home, ArrowRight, Network, Monitor, Wrench } from "lucide-react";
...
const services = [
  ...
  {
    icon: Network,
    name: "Fornecimento e Instalação de Redes",
    desc: "Instalação de redes LAN, Wi-Fi empresarial, switches, routers e cabeamento estruturado para escritórios e empresas.",
    price: "Sob cotação",
    priceNote: "levantamento técnico necessário",
    color: "bg-blue-700",
    waMsg: "Olá! Quero solicitar fornecimento e instalação de redes de computador",
    img: "/redes.jpg",
  },
  {
    icon: Monitor,
    name: "Fornecimento de Equipamento Informático",
    desc: "Venda e fornecimento de computadores, laptops, impressoras, monitores e acessórios informáticos.",
    price: "Sob cotação",
    priceNote: "conforme equipamento pretendido",
    color: "bg-slate-600",
    waMsg: "Olá! Quero solicitar fornecimento de equipamento informático",
    img: "/equipamento.jpg",
  },
  {
    icon: Wrench,
    name: "Manutenção e Reparação de Computadores e Impressoras",
    desc: "Diagnóstico, manutenção preventiva e correctiva de computadores, laptops e impressoras. Serviço rápido e profissional.",
    price: "Sob cotação",
    priceNote: "conforme avaliação técnica",
    color: "bg-orange-600",
    waMsg: "Olá! Quero solicitar manutenção/reparação de computador ou impressora",
    img: "/manutencao.jpg",
  },
];
      ...
      <div className="bg-gradient-to-b from-gray-50 to-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((s) => (
              <div key={s.name} className="card-hover bg-white rounded-2xl border border-gray-100 shadow-sm flex flex-col overflow-hidden">
                {"img" in s && s.img ? (
                  <div className="h-44 overflow-hidden">
                    <img src={(s as any).img} alt={s.name} className="w-full h-full object-cover" />
                  </div>
                ) : null}
